...
public enum SFSymbol: String, CaseIterable {
    ...
    case bitcointSignCircleFill = "bitcoinsign.circle.fill"
    ...
    case bellWavesLeftRight = "bell.and.waves.left.and.right"
    case brain = "brain"
    ...
    case macbookIphone = "macbook.and.iphone"
    case macbookIpad = "macbook.and.ipad"
    ...
    case personTwoFill = "person.2.fill"
    case personThreeFill = "person.3.fill"
